      ...
      <div className='flex flex-col lg:flex-row gap-6 items-start'>
        ...
        <div className='w-full lg:w-1/4 border border-[#E3E3E3] p-5 rounded-2xl space-y-2'>
          ...
          <div
            ...
            className='flex gap-2 justify-center items-center border border-[#296AD2] text-[#296AD2] py-3 px-4 rounded-[4px] cursor-pointer hover:bg-[#296AD2] hover:text-white transition'
          >
            {isWishlisted ? <IoHeart /> : <IoHeartOutline className='w-6 h-6' />}
            <button className='font-normal text-[18px]'>
          ...
          <div
            ...
            className={`flex gap-2 justify-center items-center py-3 px-4 rounded-[4px] transition cursor-pointer
              ${isInCart ? 'bg-gray-300 text-gray-700' : 'bg-[#296AD2] text-white hover:bg-blue-800'}`}
          >
