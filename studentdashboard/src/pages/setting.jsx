...
const Setting = () => {
    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-wrap gap-4 mt-6  pb-2">
                {['Profile', 'Password', 'Social Link'].map((tab) => (
                    <button
                        ...
                        className={`cursor-pointer px-4 py-2 text-sm sm:text-base ${activeTab === tab ? 'border-b-2 border-blue-500 text-black font-semibold' : 'text-gray-600'
                            }`}
                    >
                        {tab}
                    </button>
            ...
            {/* Profile Tab */}
            {activeTab === 'Profile' && (
                <form className="space-y-6 w-full mt-6 px-4">
                    ...
                    <button type="submit" className="cursor-pointer bg-blue-600 hover:bg-blue-700 transition text-white py-2 px-4 rounded-md">
                        Update Information
                    </button>
                </form>
            )}
